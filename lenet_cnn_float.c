...
void main() {
  ...
  // 修正为实际的数据集名称
  char *conv1_weights = "layers/conv2d/vars/0";        // 卷积层1权重
  char *conv1_bias = "layers/conv2d/vars/1";           // 卷积层1偏置
  char *conv2_weights = "layers/conv2d_1/vars/0";      // 卷积层2权重  
  char *conv2_bias = "layers/conv2d_1/vars/1";         // 卷积层2偏置
  char *fc1_weights = "layers/dense/vars/0";           // 全连接层1权重
  char *fc1_bias = "layers/dense/vars/1";              // 全连接层1偏置
  char *fc2_weights = "layers/dense_1/vars/0";         // 全连接层2权重
  char *fc2_bias = "layers/dense_1/vars/1";            // 全连接层2偏置
